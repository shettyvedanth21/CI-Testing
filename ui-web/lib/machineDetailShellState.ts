...
export function deriveMachineDetailShellState({
  ...
  return {
    ...
    uptimePercent: summary?.current_shift_uptime_percentage ?? summary?.uptime_percentage ?? fallbackUptimePercent ?? null,
    effectiveLoadState,
    currentBand,
    ...
    overviewReadiness: summary?.overview_readiness ?? {
      ...
      uptime_ready: summary?.current_shift_uptime_percentage != null || summary?.uptime_percentage != null || fallbackUptimePercent != null,
      loss_ready: false,
    },
