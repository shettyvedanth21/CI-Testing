            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                for idx, device_id in enumerate(device_ids):
                    ...
                    persisted_kpi = _merge_overlay_kpi_blocks(
                        ...
                        canonical_range=canonical if energy_basis_meta["canonical_overlay_applied"] else None,
                        duration_hours=report_window_hours,
                    )
                    if canonical and energy_basis_meta["canonical_overlay_applied"]:
                    ...
                    device_dict["energy_basis"] = energy_basis_meta["energy_basis"]
                    device_dict["canonical_overlay_applied"] = energy_basis_meta["canonical_overlay_applied"]
                    device_dict["canonical_overlay_reason"] = energy_basis_meta["canonical_overlay_reason"]
    ...
    async with AsyncSessionLocal() as db:
        ...
        try:
            ...
            if comparison_type == "machine_vs_machine":
                ...
                energy_a, basis_meta_a = _apply_canonical_energy_overlay(
                    energy_a,
                    canonical_range_a,
                ...
                energy_b, basis_meta_b = _apply_canonical_energy_overlay(
                    energy_b,
                    canonical_range_b,
                ...
                comparison_result = _overlay_comparison_energy_metrics(
                    comparison_result,
                    energy_basis_a=basis_meta_a["energy_basis"],
                    energy_basis_b=basis_meta_b["energy_basis"],
                    canonical_overlay_reason_a=basis_meta_a["canonical_overlay_reason"],
                    canonical_overlay_reason_b=basis_meta_b["canonical_overlay_reason"],
                )
